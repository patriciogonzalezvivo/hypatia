...
void ProjOps::toXY( ProjId _id, const HorPoint &_eq, double _width, double _height, double &_x, double &_y ) {
...
void ProjOps::toPolar( const HorPoint &_eq, double _width, double _height, double &_x, double &_y) {
...
void ProjOps::toFisheye(const HorPoint &_eq, double _width, double _height, double &_x, double &_y) {
...
void ProjOps::toOrtho( const HorPoint &_eq, double _width, double _height, double &_x, double &_y) {
...
void ProjOps::toStereo( const HorPoint &_eq, double _width ,double _height, double &_x, double &_y ) {
...
void ProjOps::toLambert( const HorPoint &_eq, double _width ,double _height, double &_x, double &_y ) {
...
void ProjOps::toEquirectangular( const HorPoint &_eq,  double _width ,double _height, double &_x, double &_y ) {
