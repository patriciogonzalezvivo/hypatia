...
ObsInfo::ObsInfo( double _lng_deg, double _lat_deg, Planet _planet, double _sec) : m_longitude(MathOps::toRadians(_lng_deg)), m_latitude(MathOps::toRadians(_lat_deg)), m_sec(_sec), m_jd(0.0), m_century(0.0),  m_obliquity(0.0), m_lst(0.0), m_planet(_planet), m_change(true) {
}
